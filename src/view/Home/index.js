...
const Home = () => {
    ...
    <SafeAreaView>
        ...
        <View style={{height:hp(15), width:wp(100), alignItems:"center", marginTop:10}}>
            <View style={{height:hp(10),width:wp(90),  alignItems:"center", flexDirection:"row", justifyContent: "space-around", borderWidth:1, borderRadius:10,borderColor:"#B22222", backgroundColor:"white"}}>
                ...
                <TouchableOpacity onPress={() => navigation.navigate("Profile")} style={{height:hp(8), width:wp(10), justifyContent:"center"}}>
                    <Icon name="chevron-forward" color="#B22222" size={30}/>
                </TouchableOpacity>
            </View>
            <View style={{width:wp(100), borderWidth:1.5, borderColor:"#B22222", marginTop:20}}></View>
            ...
            <Button mode="contained" theme={{colors: {primary: '#B22222'}}} onPress={() => console.log({username})}
                    style={{borderRadius:10, width:wp(90), marginTop:hp(10)}}>Input Data</Button>
        </View>
    </SafeAreaView>
  );
};
